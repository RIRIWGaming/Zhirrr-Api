...
loghandler = {
    notparam: {
        ...
        getApikey: 'tidak mempunyai apikey? chat https://wa.me/6283833271665'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, tidak mempunyai apikey? chat https://wa.me/6283833271665'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'RrwGe') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'RrwGe') return res.json(loghandler.invalidKey)
